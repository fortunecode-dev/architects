...
function Header({ sections }: { sections: string[] }) {
  ...
  return (
    <View
      ...
      className="bg-[#fdf6e3] border-b border-[#f0e6cc]"
    >
      <View className="flex flex-row justify-between items-center px-6 pt-4 h-16">
        ...
        <View className="hidden md:flex flex-row items-center gap-6">
          {sections.map((section) => (
            <TouchableOpacity key={section} className="py-2">
      ...
      {menuOpen && (
        <View className="md:hidden bg-[#fdf6e3] px-6 py-4 border-t border-[#f0e6cc] w-full h-screen">
          <Text
          ...
          <View className="border-t border-[#f0e6cc] my-5" />
...
function LandingSection() {
  return (
    <FadeInView>
      <View className="bg-[#fdf6e3] px-6 w-full h-screen flex justify-center items-center">
        <View className="mx-auto max-w-7xl w-full flex flex-col lg:flex-row items-center lg:items-start gap-12">
          {/* Logo a la izquierda con más espacio */}
          <View className="flex-shrink-0 flex justify-center lg:justify-start w-full lg:w-1/2">
            <WritingLogo />
          </View>

          {/* Divider vertical para pantallas grandes */}
          <View className="hidden lg:block border-l-2 border-[#f0c14b] h-48 mx-6" />

          {/* Contenido a la derecha */}
          <View className="w-full lg:w-1/2 text-center lg:text-left">
            <Text
...
function ServicesSection() {
  ...
  return (
    <View className="flex flex-col justify-center items-center bg-[#fdf6e3] px-6 w-full h-screen">
      <View className="mx-auto max-w-6xl w-full">
        <Text
...
function ContactSection() {
  ...
  return (
    <View className="flex justify-center items-center bg-[#f9f1d9] px-6 w-full h-screen">
      <View className="flex lg:flex-row flex-col gap-5 bg-white drop-shadow-xl mx-auto rounded-xl w-full max-w-4xl">
        {/* Contact Info */}
...
function Footer() {
  ...
  return (
    <View
      className="bg-[#fdf6e3] border-t border-[#f0e6cc]"
  ...
  return (
    <View>
      ...
      <TextInput
        ...
        multiline={true}
        numberOfLines={5}
        className="bg-white p-3 border border-[#f0e6cc] rounded-md h-32 text-[#39506b]"
