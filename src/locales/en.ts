...
export default {
  common: {
    ...
    copyright: "DwellingPlus © {year} All rights reserved.",
  ...
  landing: {
    title:
      "Our goal is to help you develop your property. We work with passion to meet the expectations of home owners and developers.",
  },
  ...
  services: {
    ...
    servicesList: [
      ...
      },
      {
        ...
        content:
          "Through credit options or structured loans, homeowners can invest in an Auxiliary Dwelling Unit (ADU) or improve their home, distributing the payment in affordable installments. This service provides financial flexibility, facilitating the materialization of projects without compromising economic stability.",
      },
    ],
  },
  ...
  faq: {
    ...
    contactPrompt: "Give us a way to contact you",
  ...
  contact: {
    ...
    emailPrompt: "Email us to discuss your project",
    form: {
